...
[
    ...
    { key = "ctrl+shift+[Period]";   command = "-editor.action.commentLine";
                                        when = "editorTextFocus && !editorReadonly"; }
    ...
    { key = "ctrl+shift+f3";         command = "-editor.action.previousSelectionMatchFindAction";
                                        when = "editorFocus"; }
    { key = "ctrl+shift+[Comma]";    command = "-editor.action.quickFix";
    ...
    { key = "ctrl+shift+[Comma]";    command = "-editor.changeDropType";
                                        when = "dropWidgetVisible"; }
    { key = "ctrl+shift+[Comma]";    command = "-editor.changePasteType";
                                        when = "pasteWidgetVisible"; }
    { key = "ctrl+k ctrl+[KeyM]";    command = "-editor.createFoldingRangeFromSelection";
    ...
    { key = "ctrl+k ctrl+0";         command = "-editor.foldAll";
                                        when = "editorTextFocus && foldingEnabled"; }
    { key = "ctrl+k ctrl+shift+[Period]"; command = "-editor.foldAllBlockComments";
                                        when = "editorTextFocus && foldingEnabled"; }
    { key = "ctrl+k ctrl+6";         command = "-editor.foldAllExcept";
                                        when = "editorTextFocus && foldingEnabled"; }
    ...
    { key = "escape";                command = "-editor.hidePasteWidget";
                                        when = "pasteWidgetVisible"; }
    { key = "ctrl+k ctrl+shift+[Comma]"; command = "-editor.removeManualFoldingRanges";
                                        when = "editorTextFocus && foldingEnabled"; }
    ...
    { key = "ctrl+enter";            command = "-mergeEditor.acceptMerge";
                                        when = "isMergeEditor"; }
    { key = "alt+f5";                command = "-multiDiffEditor.goToNextChange";
                                        when = "activeEditor == 'multiDiffEditor'"; }
    { key = "shift+alt+f5";          command = "-multiDiffEditor.goToPreviousChange";
                                        when = "activeEditor == 'multiDiffEditor'"; }
    ...
    { key = "alt+f9";                command = "-testing.coverage.goToNextMissedLine";
                                        when = "activeEditor && testing.hasCoverageInFile"; }
    { key = "shift+alt+f9";          command = "-testing.coverage.goToPreviousMissedLine";
                                        when = "activeEditor && testing.hasCoverageInFile"; }
    { key = "ctrl+shift+[Period]";   command = "-toggleExplainMode";
                                        when = "suggestWidgetVisible"; }
    { key = "ctrl+k f2";             command = "-togglePeekWidgetFocus";
                                        when = "inReferenceSearchEditor || referenceSearchVisible"; }
    { key = "ctrl+k f2";             command = "-toggleQuickDiffWidgetFocus";
    ...
    { key = "enter";                 command = "-workbench.action.browser.findNext";
                                        when = "browserFindWidgetFocused && activeEditor == 'workbench.editor.browser'"; }
    { key = "f3";                    command = "-workbench.action.browser.findNext";
                                        when = "browserFindWidgetVisible && activeEditor == 'workbench.editor.browser'"; }
    { key = "shift+enter";           command = "-workbench.action.browser.findPrevious";
                                        when = "browserFindWidgetFocused && activeEditor == 'workbench.editor.browser'"; }
    { key = "shift+f3";              command = "-workbench.action.browser.findPrevious";
                                        when = "browserFindWidgetVisible && activeEditor == 'workbench.editor.browser'"; }
    { key = "ctrl+f";                command = "-workbench.action.browser.showFind";
                                        when = "browserHasUrl && !browserHasError && activeEditor == 'workbench.editor.browser'"; }
    { key = "ctrl+shift+[Period]";   command = "-workbench.action.chat.attachContext";
                                        when = "inChatInput && chatLocation == 'panel'"; }
    { key = "ctrl+shift+[Comma]";    command = "-workbench.action.chat.openModePicker";
    ...
    { key = "escape";                command = "-workbench.action.hideComment";
                                        when = "commentEditorFocused || commentFocused"; }
    { key = "ctrl+escape";           command = "-workbench.action.hideComment";
    ...
    { key = "alt+p";                 command = "-togglePreserveCase";
                                        when = "editorFocus"; }
    { key = "escape";                command = "-workbench.action.browser.hideFind";
                                        when = "browserFindWidgetVisible && activeEditor == 'workbench.editor.browser'"; }
    ...
    { key = "ctrl+[Period]";         command = "-breadcrumbs.focus";
    ...
    { key = "alt+6";                 command = "-decreaseSearchEditorContextLines";
                                        when = "inSearchEditor"; }
    ...
    { key = "ctrl+shift+[Period]";   command = "-editor.action.accessibleViewAcceptInlineCompletion";
    ...
    { key = "ctrl+k ctrl+k";         command = "-editor.action.defineKeybinding";
                                        when = "resource == 'vscode-userdata:/home/raph/.config/VSCodium/User/keybindings.json'"; }
    ...
    { key = "alt+up";                command = "-notebook.cell.moveUp";
                                        when = "notebookEditorFocused && !inputFocus"; }
    { key = "ctrl+shift+[Comma]";    command = "-notebook.cell.openFailureActions";
    ...
    { key = "ctrl+l";                command = "-notebook.centerActiveCell";
                                        when = "notebookEditorFocused"; }
    { key = "ctrl+shift+[Period]";   command = "-notebook.commentSelectedCells";
    ...
    { key = "ctrl+enter";            command = "-problems.action.openToSide";
                                        when = "problemFocus"; }
    { key = "ctrl+shift+[Comma]";    command = "-problems.action.showQuickFixes";
                                        when = "problemFocus"; }
    ...
    { key = "alt+up";                command = "-quickInput.previousSeparatorWithQuickAccessFallback";
                                        when = "inQuickInput && quickInputType == 'quickPick' || inQuickInput && quickInputType == 'quickTree'"; }
    { key = "space";                 command = "-quickInput.toggleCheckbox";
    ...
    { key = "escape";                command = "-scm.clearValidation";
    ...
    { key = "shift+f9";              command = "-settings.action.showContextMenu";
                                        when = "inSettingsEditor"; }
    { key = "ctrl+c";                command = "-suggestWidgetCopy";
                                        when = "suggestWidgetDetailsFocused"; }
    { key = "ctrl+[Comma] ctrl+x";   command = "-testing.cancelRun"; }
    { key = "ctrl+[Comma] ctrl+shift+a"; command = "-testing.coverageAll"; }
    { key = "ctrl+[Comma] ctrl+shift+c"; command = "-testing.coverageAtCursor";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] ctrl+shift+f"; command = "-testing.coverageCurrentFile";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] ctrl+shift+l"; command = "-testing.coverageLastRun"; }
    { key = "ctrl+[Comma] ctrl+a";   command = "-testing.debugAll"; }
    { key = "ctrl+[Comma] ctrl+c";   command = "-testing.debugAtCursor";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] ctrl+f";   command = "-testing.debugCurrentFile";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] ctrl+e";   command = "-testing.debugFailTests"; }
    { key = "ctrl+[Comma] ctrl+l";   command = "-testing.debugLastRun"; }
    { key = "ctrl+[Comma] ctrl+m";   command = "-testing.openOutputPeek"; }
    { key = "ctrl+[Comma] e";        command = "-testing.reRunFailTests"; }
    { key = "ctrl+[Comma] l";        command = "-testing.reRunLastRun"; }
    { key = "ctrl+[Comma] ctrl+r";   command = "-testing.refreshTests";
                                        when = "testing.canRefresh"; }
    { key = "ctrl+[Comma] a";        command = "-testing.runAll"; }
    { key = "ctrl+[Comma] c";        command = "-testing.runAtCursor";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] f";        command = "-testing.runCurrentFile";
                                        when = "editorTextFocus"; }
    { key = "ctrl+[Comma] ctrl+o";   command = "-testing.showMostRecentOutput";
                                        when = "testing.hasAnyResults"; }
    { key = "ctrl+[Comma] ctrl+shift+i"; command = "-testing.toggleInlineCoverage"; }
    { key = "ctrl+[Comma] ctrl+i";   command = "-testing.toggleInlineTestOutput"; }
    ...
    { key = "ctrl+shift+[KeyM]";     command = "-workbench.action.chat.focusTip";
    ...
    { key = "ctrl+f9";               command = "-workbench.action.chat.nextFileTree";
                                        when = "chatIsEnabled && inChat"; }
    { key = "alt+n";                 command = "-workbench.action.chat.nextQuestion";
    ...
    { key = "ctrl+alt+i";            command = "-workbench.action.chat.open";
                                        when = "!chatSetupDisabled && !chatSetupHidden && !config.chat.disableAIFeatures"; }
    { key = "ctrl+shift+alt+[Comma]"; command = "-workbench.action.chat.openModelPicker";
                                        when = "chatIsEnabled && inChatInput"; }
    { key = "ctrl+shift+alt+i";      command = "-workbench.action.chat.openagent";
                                        when = "config.chat.agent.enabled && !chatSetupDisabled && !chatSetupHidden && !config.chat.disableAIFeatures"; }
    ...
    { key = "ctrl+shift+f9";         command = "-workbench.action.chat.previousFileTree";
                                        when = "chatIsEnabled && inChat"; }
    { key = "alt+p";                 command = "-workbench.action.chat.previousQuestion";
                                        when = "chatHasQuestionCarousel && inChat && inChatQuestionCarousel"; }
    ...
    { key = "ctrl+shift+alt+meta+[Period]"; command = "-workbench.action.chat.run-in-new-chat.prompt.current";
                                        when = "chatIsEnabled && editorTextFocus && resourceSet && resourceLangId == 'prompt'"; }
    { key = "shift+alt+meta+[Period]"; command = "-workbench.action.chat.run.prompt";
                                        when = "chatIsEnabled"; }
    { key = "shift+alt+meta+[Period]"; command = "-workbench.action.chat.run.prompt.current";
                                        when = "chatIsEnabled && editorTextFocus && resourceSet && resourceLangId == 'prompt'"; }
    ...
    { key = "ctrl+8";                command = "-workbench.action.navigateForward";
                                        when = "canNavigateForward"; }
    { key = "ctrl+shift+6";          command = "-workbench.action.navigateForward";
                                        when = "canNavigateForward"; }
    ...
    { key = "ctrl+[KeyM]";           command = "-workbench.action.openSettings"; }
    ...
    { key = "ctrl+shift+alt+[Backquote]"; command = "-workbench.action.terminal.newInNewWindow";
    ...
    { key = "ctrl+shift+6";          command = "-workbench.action.terminal.sendSequence";
                                        when = "terminalFocus";
                                        args = {text = "\u001e";};}
    { key = "ctrl+shift+[Comma]";    command = "-workbench.action.terminal.showQuickFixes";
                                        when = "terminalFocus"; }
    ...
    { key = "ctrl+6";                command = "-workbench.action.zoomOut"; }
    ...
    { key = "escape";                command = "-inlineChat2.cancel";
    ...
    { key = "ctrl+a";                command = "-notebook.cell.output.selectAll";
                                        when = "notebookEditorFocused && notebookOutputFocused"; }
    { key = "f3";                    command = "-notebook.findNext.fromWidget";
                                        when = "findWidgetVisible && notebookEditorFocused"; }
    { key = "shift+f3";              command = "-notebook.findPrevious.fromWidget";
                                        when = "findWidgetVisible && notebookEditorFocused"; }
    ...
    { key = "ctrl+shift+a";          command = "-notification.acceptPrimaryAction";
                                        when = "notificationFocus || notificationToastsVisible"; }
    { key = "ctrl+shift+[Period]";   command = "-terminalSuggestToggleExplainMode";
    ...
    { key = "ctrl+space";            command = "-workbench.action.terminal.triggerSuggest";
    ...
    { key = "alt+down";              command = "-workbench.action.navigateModalEditorNext";
                                        when = "editorPartModal && editorPartModalNavigation"; }
    { key = "alt+up";                command = "-workbench.action.navigateModalEditorPrevious";
                                        when = "editorPartModal && editorPartModalNavigation"; }
    { key = "shift+escape";          command = "-closeReferenceSearch";
    ...
    { key = "alt+left";              command = "-workbench.action.browser.goBack";
                                        when = "browserCanGoBack && activeEditor == 'workbench.editor.browser'"; }
    { key = "browserforward";        command = "-workbench.action.browser.goForward";
                                        when = "browserCanGoForward && activeEditor == 'workbench.editor.browser'"; }
    { key = "alt+right";             command = "-workbench.action.browser.goForward";
                                        when = "browserCanGoForward && activeEditor == 'workbench.editor.browser'"; }
    { key = "ctrl+t";                command = "-workbench.action.browser.newTab";
                                        when = "activeEditor == 'workbench.editor.browser'"; }
    ...
    { key = "ctrl+numpad_subtract";  command = "-workbench.action.browser.zoomOut";
                                        when = "browserFocused && browserHasUrl && !browserHasError && activeEditor == 'workbench.editor.browser'"; }
    { key = "ctrl+6";                command = "-workbench.action.browser.zoomOut";
                                        when = "browserFocused && browserHasUrl && !browserHasError && activeEditor == 'workbench.editor.browser'"; }
    { key = "escape";                command = "-notifications.hideToasts";
                                        when = "notificationFocus && notificationToastsVisible"; }
    ...
    { key = "escape";                command = "-workbench.action.terminal.stopVoice";
    ...
    { key = "ctrl+shift+[IntlBackslash]"; command = "-github.copilot.chat.copilotCLI.addFileReference";
    ...
    { key = "ctrl+enter";            command = "-chat.inlineResourceAnchor.openToSide";
                                        when = "chatAttachmentResource"; }
    { key = "ctrl+shift+alt+[Comma]"; command = "-github.copilot.chat.rerunWithCopilotDebug";
    ...
    { key = "ctrl+space";            command = "-workbench.action.terminal.suggestToggleDetails";
                                        when = "simpleSuggestWidgetHasFocusedSuggestion && terminalFocus && terminalHasBeenCreated && terminalIsOpen && terminalSuggestWidgetVisible || simpleSuggestWidgetHasFocusedSuggestion && terminalFocus && terminalIsOpen && terminalProcessSupported && terminalSuggestWidgetVisible"; }
    { key = "ctrl+enter";            command = "-github.copilot.nes.captureExpected.confirm";
                                        when = "copilotNesCaptureMode && editorTextFocus"; }
    { key = "escape";                command = "-github.copilot.nes.captureExpected.abort";
                                        when = "copilotNesCaptureMode && editorTextFocus"; }
    { key = "ctrl+shift+[Comma]";    command = "-acceptSelectedCodeAction";
                                        when = "codeActionMenuVisible"; }
    { key = "enter";                 command = "-acceptSelectedCodeAction";
                                        when = "codeActionMenuVisible"; }
    { key = "left";                  command = "-collapseSectionCodeAction";
                                        when = "codeActionMenuVisible && !codeActionMenuFilterFocused"; }
    { key = "right";                 command = "-expandSectionCodeAction";
                                        when = "codeActionMenuVisible && !codeActionMenuFilterFocused"; }
    ...
    { key = "up";                    command = "-selectPrevCodeAction";
                                        when = "codeActionMenuVisible"; }
    { key = "space";                 command = "-toggleSectionCodeAction";
                                        when = "codeActionMenuVisible && !codeActionMenuFilterFocused"; }
    { key = "escape";                command = "-clearFilterCodeActionWidget";
